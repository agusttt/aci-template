			...
			<div class="row">
				...
				<div class="col-lg-8 col-md-8 col-sm-12 col-12">
					<div class="wrp-title-csr-detail">
						<h1>Economic Development Pillar Development Small Medium Enterprise (UMKM)</h1>
					</div>		
				</div>
				<div class="col"></div>							
			</div>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-12">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb breadcrumb-article">
									...
									<li class="breadcrumb-item active" aria-current="page">Economic Development Pillar</li>
								</ol>
							</nav>
						</div>
					</div>		
			...
			<div class="row">
				...
				<div class="col-lg-8 col-md-8 col-sm-12 col-12">
					<div class="wrp-job-desc">
						<h3>Development Small Medium Enterprise (UMKM)</h3>		
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-12 col-12">
								<div class="story-csr-gallery story-csr-count-1">
										<img src="assets/images/story-image-gallery-economic-dev-1.jpg" alt="education pillar - Marketing education">
								</div>
								<div class="caption-content-csr">
									<p><b>Garmendy Tailor - T-shirt</b></p>
								</div>									
							</div>
							<div class="col-lg-6 col-md-6 col-sm-12 col-12">
								<div class="story-csr-gallery story-csr-count-1">
										<img src="assets/images/story-image-gallery-economic-dev-2.jpg" alt="education pillar - Marketing education">
								</div>
								<div class="caption-content-csr">
									<p><b>Tunas Mekar Tailor - Majun</b></p>
								</div>									
							</div>							
						</div>	
						<div class="story-csr-gallery story-csr-count-1">
								<img src="assets/images/story-image-gallery-economic-dev-3.jpg" alt="education pillar - Marketing education">
						</div>
						<div class="caption-content-csr">
							<p><b>Sinar Gerem - Motorcycle Workshop</b></p>
						</div>																														
					</div>						
				</div>
				<div class="col"></div>							
