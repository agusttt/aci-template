			...
			<div class="row">
				...
				<div class="col-lg-8 col-md-8 col-sm-12 col-12">
					<div class="wrp-title-csr-detail">
						<h1>Pembangunan taman bacaan Saung aksara Sindangbarang, Cilegon, Banten</h1>
					</div>		
				</div>
				<div class="col"></div>							
			</div>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-12">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb breadcrumb-article">
									...
									<li class="breadcrumb-item"><a href="csr-list.php">Education Pillar Program</a></li>
									<li class="breadcrumb-item active" aria-current="page">Taman Bacaan Saung Aksara</li>
								</ol>
							</nav>
						</div>
					</div>		
			...
			<div class="row">
				...
				<div class="col-lg-8 col-md-8 col-sm-12 col-12">
					<div class="wrp-job-desc">
						<h3>Saung Aksara</h3>
						<p>Our education program is designed to enhance the knowledge and skills of the community. The program includes:</p>
						<ol>
							<li>
								<p>Providing English and Math courses</p>
							</li>
							<li>
								<p>Establishing a library</p>
							</li>
							<li>
								<p>Providing computer and internet education</p>
							</li>
							<li>
								<p>Nurturing the community in becoming T-shirt printing entrepreneur</p>
							</li>
							<li>
								<p>Marketing education</p>
							</li>
							<li>
								<p>Saung Aksara competition</p>
							</li>
						</ol>
						<h3>Marketing education</h3>
						<div class="caption-content-csr">
							<p><b>Food Training</b></p>
						</div>						
						<div class="story-csr-gallery story-csr-count-1">
								<img src="assets/images/story-image-gallery-education-pillar-1.jpg" alt="education pillar - Marketing education">
						</div>
						<div class="story-csr-gallery story-csr-count-2">
							<div class="story-csr-gallery-item-left">
								<img src="assets/images/story-image-gallery-education-pillar-2.jpg" alt="education pillar - Marketing education">
							</div>			
							<div class="story-csr-gallery-item-right">
								<img src="assets/images/story-image-gallery-education-pillar-3.jpg" alt="education pillar - Marketing education">
							</div>				
						</div>
						<p></p>
						<div class="caption-content-csr">
							<p><b>Marketing Online Training</b></p>
						</div>				
						<div class="story-csr-gallery story-csr-count-1">
								<img src="assets/images/story-image-gallery-education-pillar-4.jpg" alt="education pillar - Marketing education">
						</div>									
					</div>						
				</div>
				<div class="col"></div>							
