			...
			<div class="container">
				...
				<div class="row align-items-center">
					<div class="col-lg-6 col-md-6 col-sm-12">
						<div class="wrp-left-of-csr">
							<h3>Corporate Social Responsibility</h3>
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12">
						<div class="wrp-right-of-career">
							<p>As a subsidiary of Mitsubishi Chemical Holding Corporation (MCHC), MFI's CSR should also reflect the KAITEKI values: a state of true sustainability and also represent comfort for people, society and planet as a whole.</p>
						</div>
					</div>
				</div>	
			</div>
			...
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
					<div class="opening-career-text">
						<h3>Our CSR programs constitute three pillars:</h3>
					</div>
					<div class="paragraph-opening-career">
						<p>Based on CSR policy, Our CSR program divided into 3 pillar programs, namely : Health, Education, Economical Development</p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-6 col-12">
					<div class="wrp-card-csr">
						<div class="thumbnail-csr-card">
							<a href="csr-list.php">
								<img src="assets/images/card-thumbnail-csr.jpg" alt="MFI CSR Program">	
							</a>
						</div>
						<div class="desc-csr-card">
							<a href="csr-list.php">
								<h2>Health Pillar</h2>
							</a>
							<div class="read-similiar">
								<a class="btn btn-md-outline" href="csr-list.php">See Detail</a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 col-12">
					<div class="wrp-card-csr">
						<div class="thumbnail-csr-card">
							<a href="csr-list.php">
								<img src="assets/images/card-thumbnail-csr-3.jpg" alt="MFI CSR Program">	
							</a>
						</div>
						<div class="desc-csr-card">
							<a href="csr-list.php">
								<h2>Economical Development Pillar</h2>
							</a>
							<div class="read-similiar">
								<a class="btn btn-md-outline" href="csr-list.php">See Detail</a>
							</div>
