...
<head>
	...
	<title>Career at MFI - PT. MC PET FILM INDONESIA</title>
...
<body>
	...
	<div class="parallax-window" data-parallax="scroll"
		data-image-src="assets/images/bg-cover-career-at-mfi.jpg">
	</div>
			...
			<div class="row">
				...
				<div class="col-lg-8 col-md-8 col-sm-12 col-12">
					<div class="wrp-job-desc">
						<h3>Recruitment email:</h3>
						<p><a target="_blank"  href="mailto: MCAP-MBX-MFI_RECRUITMENT@mchcgr.com">MCAP-MBX-MFI_RECRUITMENT@mchcgr.com</a></p>
						<h3>Linkedin link:</h3>
						<p><a target="_blank" href="https://www.linkedin.com/company/mc-pet-film-indonesia-pt">https://www.linkedin.com/company/mc-pet-film-indonesia-pt</a></p>
						<h3>Choose department:</h3>
						<p>Administration, Corporate Affairs, Coordination, Quality Control, Production, Engineering, Logistic, Procurement, Finance, Marketing</p>								
						<p><br></p>
						<h3>Why MFI</h3>
						<p>MFI always values its human capital as one of the company’s crucial assets. Hence, MFI ensures their competencies and enthusiasm towards achieving high productivity and creativity. Our presence in the industry is also counted as our commitment to contributing to the welfare of
								our employees and the communities surrounding the company’s operations, as well as the planet we live in. To realize this, we only use eco-
								friendly materials in producing our high-quality products.</p>
					</div>						
				</div>
				<div class="col"></div>							
			</div>
					...
					<div class="opening-career-why">
						<div class="row">
							...
							<div class="col-lg-8 col-md-8 col-sm-12 col-12">
								...
								<div class="paragraph-why-mfi">
								achieving high productivity and creativity. Our presence in the industry is also counted as our commitment to contributing to the welfare of
								our employees and the communities surrounding the company’s operations, as well as the planet we live in. To realize this, we only use eco-
								friendly materials in producing our high-quality products.</p>
								</div>								
							</div>
