...
<head>
	...
	<title>Staff Technical Production - Career at MFI PT. MC PET FILM INDONESIA</title>
							...
							<nav class="navbar navbar-expand-lg navbar-centered">
								...
								<div class="navbar-collapse collapse" id="navbar-yappika">
									<ul class="navbar-nav nav-fill w-100">
										...
										<li class="nav-item">
											<a class="nav-link menu-item" href="list-career.php">Career</a>
										</li>
										<li class="nav-item">
		...
		<div class="container">
				...
				<div class="col-lg-8 col-md-8 col-sm-12 col-12">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb breadcrumb-white">
							...
							<li class="breadcrumb-item"><a href="list-career.php">Career</a></li>
							<li class="breadcrumb-item active" aria-current="page">Staff Technical Production</li>
						</ol>
					</nav>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-lg-8 col-md-12 col-sm-12 col-12">
					<div class="wrp-title-career">
						<h1>Staff Technical Production - MFI Indonesia</h1>
					</div>
					<div class="location-and-date">
						<div class="loc-and-date">
							<h4>Jakarta, Indonesia</h4>
						</div>
						<div class="loc-and-date">
							<h4>Registration date: 12 Mei - 31 Sep 2021</h4>
						</div>						
					</div>
					<div class="litle-information-jobs">
						<div class="list-job-info">
							<p>Departement: <span>Production</span></p>
						</div>
						<div class="list-job-info">
							<p>Type: <span>Full Time</span></p>
						</div>		
						<div class="list-job-info">
							<p>Experience: <span>2 to 3 years</span></p>
						</div>												
					</div>
				</div>
				<div class="col"></div>
			...
			<div class="row">
				<div class="col"></div>
				<div class="col-lg-8 col-md-12 col-sm-12 col-12">
					<div class="wrp-job-desc">
						<h3>Job description & requirements</h3>
						<p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors.
 now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p>
						...
						<ul>
							<li>
								<p>Exhibits business process knowledge and possesses a broad based operational perspective</p>
							</li>
							<li>
								<p>Excellent communication skill.</p>
							</li>
							<li>
								<p>Can work on different level of abstractions.</p>
							</li>
							<li>
								<p>Strong in logical reasoning and pattern recognition.</p>
							</li>
							<li>
								<p>Creative or comprehensive perspective on different angle of risks and workaround.</p>
							</li>
							<li>
								<p>The typical candidate has more than 5 years experience not necessarily in risk management.</p>
							</li>
						</ul>
						<h3>What You Will Get:</h3>
						<ol>
							<li>
								<p>Competitive salary + daily allowance</p>
							</li>
							<li>
								<p>Excellent communication skill.</p>
							</li>
			...
			<div class="row">
				<div class="col"></div>
				<div class="col-lg-8 col-md-12 col-sm-12 spesial-share-column">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-12 order-xl-1 order-lg-1 order-md-1 order-sm-12 order-xs-12 order-12">
							<a class="btn btn-md-blue" href="career-detail.php">Apply Now</a>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12 order-xl-12 order-lg-12 order-md-12 order-sm-1 order-xs-1 order-1 share-loker">
							<div class="share-top-socmed">
								<div class="left-share-label">
									<p>Share this</p>
									<span>Job oportunity</span>
								</div>
								<div class="right-share-label">
									<ul>
										<li>
											<a target="_blank" href="#">
												<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="20px" height="20px" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xml:space="preserve">
										...
										<li>
											<a target="_blank" href="#">
												<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="20px" height="20px" viewBox="0 0 64 64" enable-background="new 0 0 64 64" xml:space="preserve">
												<path d="M53.395,7H10.606C8.615,7,7,8.615,7,10.606v42.789C7,55.386,8.615,57,10.606,57h42.789
													C55.386,57,57,55.386,57,53.395V10.606C57,8.615,55.386,7,53.395,7z M24,45h-5V27h5V45z M21.691,23h-0.039
													c-2.043,0-3.365-0.92-3.365-2.678c0-1.797,1.362-2.921,3.445-2.921s3.364,1.002,3.403,2.8C25.135,21.958,23.814,23,21.691,23z
													M46,45h-5V34.992c0-2.461-1.082-4.141-3.283-4.141c-1.684,0-2.88,1.132-3.32,2.227C34.236,33.469,34,34.016,34,34.563V45h-5.895
													c0,0,0.08-17,0-18H34v2.069c1-1.249,2.008-3.024,5.238-3.024c4.007,0,6.762,2.618,6.762,8.245V45z"></path>
												</svg>	
											</a>
										</li>
									</ul>
	...
	<!-- section career detail -->	
	<!-- section similiar opening -->
	<section class="section-similiar-opening">
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-sm-12 col-12">
					<div class="opening-career-text">
			...
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-12 col-12">
					<div class="wrp-similiar-opening">
						<div class="title-similiar-open">
							<a href="#">
								<h2>Staff Administration</h2>
								<h3>Banten, Jakarta</h3>
							</a>
							<span class="label-type-job">Full Time</span>
						</div>
						<div class="read-similiar">
							<a class="btn btn-md-outline" href="career-detail.php">Lihat Detail</a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12 col-12">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-12">
						<div class="third-column-footer">
							...
							<div class="footer-line-nav">
								<a href="list-career.php"><h3>Career</h3></a>
							</div>	
							<div class="footer-line-nav">
	...
	<script>
		var image = document.getElementsByClassName('footerpresiden');
