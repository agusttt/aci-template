				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
						<div class="content-company-slogan">
							...
							<p>As Mitsubishi Chemical Holdings Group the MC PET Film Indonesia Corporation will :</p>
						</div>
						<div class="will-responsibility-list">
							<div class="icon-left-list">
								<img src="assets/images/icon-realizing-kaiteki.jpg" alt="Realizing KAITEKI">
							</div>
							<h4>Realizing KAITEKI</h4>
						...
						<div class="will-responsibility-list">
							<div class="icon-left-list">
								<img src="assets/images/icon-hight-quality.jpg" alt="providing hight quality plastik">
							</div>							
							<h4>Providing a Highly Qualified Plastic </h4>
							<p>A good process makes a good product. Our product is a highly qualified plastic</p>
						</div>
						<div class="will-responsibility-list">
							<div class="icon-left-list">
								<img src="assets/images/icon-working-environment.jpg" alt="Provide working environment zero accident">
							</div>								
							<h4>Provide working environment can motivate and support all employee to achieve zero accident</h4>
							<p>we provide various solutions for solving social and environmental issues</p>
						</div>
