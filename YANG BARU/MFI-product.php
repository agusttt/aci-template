...
<body>
				...
				<div class="col-2"></div>
					<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
						<div class="content-company-slogan-news-detail">
							<h2>Biaxially Oriented Polyester Film (Diafoil®)</h2>
							<p> <a href="index.php">Home / </a><a href="">Product	 / </a>Biaxially Oriented Polyester Film (Diafoil®)</p>
						</div>
					</div>
				<div class="col-2"></div>
				</div>
	...
	<div class="parallax-window" data-parallax="scroll"
		data-image-src="assets/images/MFI-PRODUCT.jpg">
	</div>
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
						<div class="content-company-slogan">
							<p>With a comprehensive lineup of polyester film, ranging from a few microns to 350 microns in thickness and featuring well-balanced characteristics such as mechanical properties and heat resistance. Customers across the globe in further increasing applications have been using DIAFOIL.</p>
							<br>
							<p>We integrate three technologies of Mitsubishi Chemicals, namely, excellent and proprietary material technologies, film-forming technology cultivated over many years and surface treatment technology with unique coating, and develop new markets with</p>
						</div>

						<div class="content-company-slogan-news-detail mt-5 mb-4">
							<h2>Applications</h2>
						</div>

						<div class="row content-company-slogan">
							<div class="col-4 img-mfi-product">
								<img src="assets/images/lcd-display.jpg" alt="lcd-display">
							</div>
							<div class="col-8">
								<h3 class="mb-1 mfi-product-title">Flat Panel Display</h3>
								<p>As polyester film is excellent in terms of transparency, smoothness, and heat resistance, it is widely used as the base for optical sheets of LCD backlights. Other applications include optical filter material for PDP and protective / mold release films for LCD components.</p>
							</div>
						</div>
						<hr class="mt-5 mb-5">
						<div class="row content-company-slogan">
							<div class="col-4 img-mfi-product">
								<img src="assets/images/pcb-boards.jpg" alt="pcb-boards">
							</div>
							<div class="col-8">
								<h3 class="mb-1 mfi-product-title">Electric / Electronic Parts and Components</h3>
								<p>With its excellent electrical and physical properties including heat resistance and slip characteristics as well as high insulation, dimensional stability and high transparency, DIAFOIL has been highly appreciated for its applications in electric / electronic parts and components such as wires, cables, motor insulation, touch panels and flexible boards.</p>
							</div>
						</div>
						<hr class="mt-5 mb-5">
						<div class="row content-company-slogan">
							<div class="col-4 img-mfi-product">
								<img src="assets/images/mfi-product-cube.jpg" alt="mfi-product-cube">
							</div>
							<div class="col-8">
								<h3 class="mb-1 mfi-product-title">General Industrial / Special Products</h3>
						...
						<div class="row content-company-slogan">
							...
							<div class="col-8">
								<h3 class="mb-1 mfi-product-title">General Industrial / Special Products</h3>
								<p>Ranging from a few microns to 350 microns in thickness and with excellent properties such as heat resistance, dimensional stability and chemical resistance. DIAFOIL is an essential product in various fields of industry, used in applications such as transfer foil, mold release film, cards, Jabels, sheets and mold release film for ceramic capacitors.</p>
							</div>
						</div>
