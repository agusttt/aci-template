...
<body>
			...
			<div class="row">
				<div class="col-2"></div>
					<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
						<div class="content-company-slogan-news-detail">
							<h2>Capture the World through Creation and Innovation</h2>
							<!-- <p> <a href="index.php">Home / </a><a href="">About Us / </a>Welcome Message</p> -->
						</div>
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb breadcrumb-white">
										...
										<li class="breadcrumb-item"><a href="list-news.php">News and Article</a></li>
										<li class="breadcrumb-item active" aria-current="page">News and Article</li>
									</ol>
								</nav>
							</div>								
						</div>
		...
		<div class="wrp-section-company-slogan">
			<div class="container">
				<div class="row">
					<div class="col-2"></div>
					<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
						<div class="content-company-slogan">
							
							<p>Our commitment to building customer relationships and meeting societal needs drives us to deliver innovative solutions. </p>
							<br>
							<p>Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a tyYpe specimen book. It has survived</p>
							<br>
							...
							<br>
							<p>As a member of Mitsubishi Chemical Holdings Group, we believe that a good company has a great responsibility to the people, society and the Earth, not merely a profit seeker. We build trust and good reputation.</p>
						</div>						
					</div>
					<div class="col-2"></div>					
				</div>
	...
	<!-- section news detail end -->


	<!-- section other news start -->
			...
			<div class="row">
				<div class="col-1"></div>
					<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
						<div class="content-company-slogan-other-news">

							<h2><strong>Other News</strong></h2>
							<div class="row">

								<div class="col-md-6">
									<div class="card card-noborder mb-3" style="max-width: 540px;">
										<div class="row no-gutters">
											<div class="col-md-4 left-image-card">
												<img src="https://images.unsplash.com/photo-1524758631624-e2822e304c36?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" alt="image">
											</div>
											<div class="col-md-8">
												<div class="card-body">
													<p class="card-text">News Title Lorem ipsum dolor sit amet consectetur</p>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="col-md-6">
									<div class="card card-noborder mb-3" style="max-width: 540px;">
										<div class="row no-gutters left-image-card">
											<div class="col-md-4">
												<img src="https://images.unsplash.com/photo-1524758631624-e2822e304c36?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" alt="image">
											</div>
											<div class="col-md-8">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-12">
						<div class="third-column-footer">
							...
							<div class="footer-line-nav">
								<a href="#"><h3>News and Article</h3></a>
							</div>		
							<div class="footer-line-nav">
