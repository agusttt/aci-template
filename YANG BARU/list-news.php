			...
			<div class="wrp-featured-news">
				<div class="row">
					...
					<div class="col-lg-7 col-md-12 col-sm-12 col-12">
						<div class="large-featured-news">
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-12 col-12">
									<div class="news-large-featured">
										<a href="news-detail.php">
											<img class="img-fluid" src="assets/images/thumbnail-news-home.jpg" alt="News Featured MFI">
										</a>
									</div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-12 col-12">
									<div class="large-title-feautred">
										<a href="news-detail.php">
											<h3>Educating kids to making crafts the batik pattern</h3>
										</a>
										<p>The standard of lorem Ipsum used since the 1500s is reproduced below for those interested giving information on its origins, as well as a random lipsum generator.</p>
										<a class="link-small-more-green" href="news-detail.php">See details</a>
									</div>
								</div>								
							</div>
						</div>
