...
<head>
	...
	<title>Corporate Social Responsibility MFI - PT. MC PET FILM INDONESIA</title>
...
<body>
	...
	<div class="parallax-window" data-parallax="scroll"
		data-image-src="assets/images/bg-cover-csr-education-pillar.jpg">
	</div>
	<!-- section list career -->
	<section class="section-career">
		<div class="wrp-section-career">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-12">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb breadcrumb-white">
								...
								<li class="breadcrumb-item"><a href="csr.php">CSR</a></li>
								<li class="breadcrumb-item active" aria-current="page">Education Pillar</li>
							</ol>
						</nav>
					</div>
				</div>
				<div class="row align-items-center">
					...
					<div class="col-lg-10 col-md-10 col-sm-12 col-12">
						<div class="wrp-centered-of-csr">
							<h3>Tujuan Education Pillar Program</h3>
						</div>
						<div class="wrp-right-of-career">
							<p>Education Pillar Program Bersama MFI hadir sebagai salah satu bentuk dukungan MFI terhadap yang selaras dengan visi perusahaan untuk terus meningkatkan pendidikan masyarakat dan mencerdaskan kehidupan bangsa. Diantaranya: program Siswa Mengenal Nusantara, pembangunan Taman Bacaan Sekolah Saung Aksara, bantuan beasiswa pendidikan, perbaikan sarana dan prasarana sekolah, dan lain-lain.</p>
						</div>						
					</div>
					<div class="col"></div>
				</div>	
	...
	<!-- section list career end -->

	<!-- section career open postion -->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 col-sm-6 col-12">
					<div class="wrp-card-csr">
						<div class="thumbnail-csr-card">
							<a href="csr-detail-education.php">
								<img src="assets/images/card-thumbnail-csr-4.jpg" alt="MFI CSR Program">	
							</a>
						</div>
						<div class="title-program-csr-card">
							<a href="csr-detail-education.php">
								<h2>Perbaikan sarana dan prasarana sekolah SD Kambangan, Serang, Banten</h2>
							</a>						
							<a href="csr-detail-education.php">
				...
				<div class="col-lg-4 col-md-6 col-sm-6 col-12">
					<div class="wrp-card-csr">
						<div class="thumbnail-csr-card">
							<a href="csr-detail-education.php">
								<img src="assets/images/card-thumbnail-csr-2.jpg" alt="MFI CSR Program">	
							</a>
						</div>
						<div class="title-program-csr-card">
							<a href="csr-detail-education.php">
								<h2>Bantuan beasiswa pendidikan 100 Murid berprestasi</h2>
							</a>						
							<a href="csr-detail-education.php">
								<p>Baca Selengkapnya</p>
							</a>	
				...
				<div class="col-lg-4 col-md-6 col-sm-6 col-12">
					<div class="wrp-card-csr">
						<div class="thumbnail-csr-card">
							<a href="csr-detail-economic-dev.php">
								<img src="assets/images/card-thumbnail-csr-5.jpg" alt="MFI CSR Program - taman bacaan Saung aksara Sindangbarang">	
							</a>
						</div>
						<div class="title-program-csr-card">
							<a href="csr-detail-education.php">
								<h2>Pembangunan taman bacaan Saung aksara Sindangbarang, Cilegon, Banten</h2>
							</a>						
							<a href="csr-detail-education.php">
								<p>Baca Selengkapnya</p>
							</a>	
				...
				<div class="col-lg-4 col-md-6 col-sm-6 col-12">
					<div class="wrp-card-csr">
						<div class="thumbnail-csr-card">
							<a href="csr-detail-economic-dev.php">
								<img src="assets/images/card-thumbnail-csr-7.jpg" alt="MFI CSR Program - siswa mengenal Nusantara">	
							</a>
						</div>
						<div class="title-program-csr-card">
							<a href="csr-detail-education.php">
								<h2>Program pembekalan siswa mengenal dunia Industri Kerja</h2>
							</a>						
							<a href="csr-detail-education.php">
								<p>Baca Selengkapnya</p>
							</a>	
				...
				<div class="col-lg-4 col-md-6 col-sm-6 col-12">
					<div class="wrp-card-csr">
						<div class="thumbnail-csr-card">
							<a href="csr-detail-economic-dev.php">
								<img src="assets/images/card-thumbnail-csr-6.jpg" alt="MFI CSR Program - siswa mengenal Nusantara">	
							</a>
						</div>
						<div class="title-program-csr-card">
							<a href="csr-detail-education.php">
								<h2>Program siswa mengenal Nusantara, Cilegon, Banten</h2>
							</a>						
							<a href="csr-detail-education.php">
								<p>Baca Selengkapnya</p>
							</a>	
				...
				<div class="col-lg-4 col-md-6 col-sm-6 col-12">
					<div class="wrp-card-csr">
						<div class="thumbnail-csr-card">
							<a href="csr-detail-economic-dev.php">
								<img src="assets/images/card-thumbnail-csr-8.jpg" alt="MFI CSR Program - siswa mengenal Nusantara">	
							</a>
						</div>
						<div class="title-program-csr-card">
							<a href="csr-detail-education.php">
								<h2>Program keterampilan siswa SMK N 12 Banten</h2>
							</a>						
							<a href="csr-detail-education.php">
								<p>Baca Selengkapnya</p>
							</a>	
	...
	<!-- section career open postion end -->
