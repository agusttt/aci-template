...
<head>
	...
	<title>Corporate Social Responsibility - Healt Pillar Program MFI - PT. MC PET FILM INDONESIA</title>
...
<body>
	...
	<div class="parallax-window" data-parallax="scroll"
		data-image-src="assets/images/bg-cover-csr-health.jpg">
	</div>
		...
		<div class="container">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-12">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb breadcrumb-article">
									...
									<li class="breadcrumb-item active" aria-current="page">Health Pillar Program</li>
								</ol>
							</nav>
						</div>
					</div>		
			...
			<div class="row">
				...
				<div class="col-lg-8 col-md-8 col-sm-12 col-12">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-12 col-12">
							<div class="card-items-iso">
								<a href="#">
									<img class="img-fluid" src="assets/images/certificate-management-system-pt-mc-pet-film-indonesia-iso-9001-2015.jpg" alt="">
								</a>
								<div class="caption-iso-certificate">
									<a href="#" target="_blank">
										<h3>Certificate of Management System PT MC Pet Film Indonesia - ISO 9001:2015</h3>
										<p>Aproval number(s): ISO 9001 - 00022734</p>									
									</a>
								</div>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12 col-12">
							<div class="card-items-iso">
								...
								<div class="caption-iso-certificate">
									<a href="#" target="_blank">
										<h3>Certificate of Management System PT MC Pet Film Indonesia - ISO 14001:2015</h3>
										<p>Aproval number(s): ISO 14001 - 00022997</p>									
									</a>
								</div>
							</div>
						</div>						
	...
	<style>
		.card-items-iso{
			...
			box-shadow: 5px 10px 30px 0 rgba(0, 0, 0, 0.074);
			-ms-box-shadow: 5px 10px 39px 0 rgba(0, 0, 0, 0.074);
			width: 100%;
			height: auto;
			position: relative;
			overflow: hidden;			
		...
		.caption-iso-certificate a{
			display:block;
			overflow:hidden;

		}

		.caption-iso-certificate a img{
